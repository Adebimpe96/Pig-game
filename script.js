...
const winText = document.querySelector('.player-win');
...
const winSpan = document.querySelector('.win--0');
...
btnHold.addEventListener('click', function () {
  if (playing) {
    ...
    if (score[activePlayer] >= 20) {
      ...
      winSpan.textContent = activePlayer = activePlayer === 0 ? 1 : 2;
      // winScore.textContent = score[activePlayer]+= currentScore;
      document
        .querySelector(`.player--${activePlayer}`)
